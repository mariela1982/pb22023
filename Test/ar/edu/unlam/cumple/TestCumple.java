...
public class TestCumple {

	
	@Test
	public void queSePuedaCrearUnCumpleanios() {
		// Preparaci�n
		final String mailOrganizador = "chiquitapia@afa.com", nombreOrganizador = "Chiqui Tapia", mailAgasajado = "lio@Messi.com", nombreAgasajado = "Lionel Messi", nombreDelEvento = "cumple Messi";
...
//		principal.crear(principal.getUsuario(mailOrganizador), new Cumpleaños((Agasajado)new Usuario(mailAgasajado, nombreAgasajado, edadAgasajado)));
